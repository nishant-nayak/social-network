document.addEventListener('DOMContentLoaded', function() {
    document.querySelector('#newpost-form').onsubmit = create_post;
...
function display_post_alert(result) {
    ...
    document.querySelector('#newpost-card').insertAdjacentElement("beforebegin", ele)
